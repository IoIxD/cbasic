...
void Compiler::push_bool_eval_goto_code(
    std::string key1, std::string key2, int gotonum, std::string def,
...
void Compiler::push_bool_eval_goto_if_true(
    int linenum, std::string key, int gotonum
) {
...
void Compiler::push_bool_eval_goto_sub_if_true(
...
void Compiler::push_bool_eval_goto_if_false(
    int linenum, std::string key, int gotonum
) {
  line_num_header(linenum);
  push_bool_eval_goto_code(
...
void Compiler::push_bool_eval_goto_sub_if_false(
    int linenum, std::string key, std::string def
) {
  line_num_header(linenum);
  push_bool_eval_goto_code(
...
void Compiler::push_bool_eval_goto_if_eq(
...
void Compiler::push_bool_eval_goto_sub_if_eq(
...
void Compiler::push_bool_eval_goto_if_gt(
    int linenum, std::string key, std::string key2, int gotonum
) {
  line_num_header(linenum);
  push_bool_eval_goto_code(
...
void Compiler::push_bool_eval_goto_sub_if_gt(
    int linenum, std::string key, std::string key2, std::string def
) {
  line_num_header(linenum);
  push_bool_eval_goto_code(
...
void Compiler::push_bool_eval_goto_if_lt(
    int linenum, std::string key, std::string key2, int gotonum
) {
  line_num_header(linenum);
  push_bool_eval_goto_code(
...
void Compiler::push_bool_eval_goto_sub_if_lt(
    int linenum, std::string key, std::string key2, std::string def
) {
  line_num_header(linenum);
  push_bool_eval_goto_code(
...
void Compiler::push_bool_eval_goto_if_ge(
    int linenum, std::string key, std::string key2, int gotonum
) {
  line_num_header(linenum);
  push_bool_eval_goto_code(
...
void Compiler::push_bool_eval_goto_sub_if_ge(
    int linenum, std::string key, std::string key2, std::string def
) {
  line_num_header(linenum);
  push_bool_eval_goto_code(
...
void Compiler::push_bool_eval_goto_if_le(
    int linenum, std::string key, std::string key2, int gotonum
) {
  line_num_header(linenum);
  push_bool_eval_goto_code(
...
void Compiler::push_bool_eval_goto_sub_if_le(
    int linenum, std::string key, std::string key2, std::string def
) {
  line_num_header(linenum);
  push_bool_eval_goto_code(
